...
const ProviderDetail = () => {
    ...
    const reviewQuery = useQuery(
        ...
        async () => {
            const res = await axios.get(
                `https://apis20231023230305.azurewebsites.net/api/Comment/GetByProviderId?id=${id}&pageIndex=0&pageSize=10000`
            );
    ...
    const createFeedbackMutation = useMutation(
        async (content) => {
            ...
            return await axios.post(`https://apis20231023230305.azurewebsites.net/api/Comment/Create`, {
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="min-h-screen mt-8 mb-16 fade-in">
                <div className="flex flex-col gap-4 px-4 mx-auto mb-16 max-w-7xl">
                    <Tab.Group>
                        <Tab.List className="flex items-center ">
                            <Tab className="px-8 py-2 text-sm font-medium text-white bg-green-600 hover:bg-green-500 hover:text-white">
                                Review
                            </Tab>
                            <Tab className="px-8 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-500 hover:text-white">
                                Service
                            </Tab>
                        </Tab.List>
                        <Tab.Panels>
                            <Tab.Panel>
                                <div className="flex flex-col gap-4 mt-8">
                                    {reviewQuery.data.map((comment, index) => (
                                        <div
                                            key={index}
                                                    ...
                                                    <div
                                                        ...
                                                        onClick={() => {
                                                            ...
                                                            if (categoryIds.includes(plan.id)) {
                                                                newCategoryIds.splice(
                                                                    newCategoryIds.indexOf(plan.id),
                                                                    1
                                                                );
                                                            } else {
