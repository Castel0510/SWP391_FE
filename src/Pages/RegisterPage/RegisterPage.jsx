...
const RegisterPage = () => {
    ...
    const handleSignup = async (e) => {
        ...
        const customerCredentials = {
            ...
            user: {
                avatarURL:
                    'https://static.vecteezy.com/system/resources/previews/000/585/470/non_2x/bird-and-wing-logo-vector-template.jpg',
                fullname: fullName,
                username,
                password,
                email: 'string',
    ...
    return (
        <AuthenticationComponent>
            <div className="content">
                <h3 className="pt-8 ">Create account</h3>
                <form className="login__form-content" onSubmit={handleSignup}>
                    ...
                    {error && (
                        <div
                            className="relative w-full px-4 py-3 mt-1 text-red-700 bg-red-100 border border-red-400 rounded"
                            role="alert"
                        >
                    ...
                    <p className="text">
                        ...
                        <Link to="/login" className="text-swap">
                            {' '}
                            Log in
                        </Link>
                    </p>
