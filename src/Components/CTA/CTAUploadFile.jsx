...
const CTAUploadFile = ({ description }) => {
    ...
    const v1UploadFile = async (file) => {
        ...
        const res = await axios.post(url, formData, {
            headers: {
                Authorization:
                    'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjQwNzdkN2ZlLTI4MGUtZWRiYi1kYzVkLWJjNTY0ZmQ1ZTQ2YyIsInR5cGUiOiJBVVRIIiwiZXhwaXJlZEF0IjoxNzAxNTE3MDI2NDg4LCJpYXQiOjE2OTg5MjUwMjZ9.JTutLyY1y4CoCBQfPP47nYj655YtG-Ij4FaWyEv0lo8',
            },
        });
